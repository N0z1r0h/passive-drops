...
public class EngProvider extends FabricLanguageProvider {
    protected EngProvider(FabricPackOutput dataOutput, CompletableFuture<HolderLookup.Provider> registryLookup) {
